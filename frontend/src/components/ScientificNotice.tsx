...
export function ScientificNotice({
  ...
  scope?: "educational" | "lattice" | "atomos" | "moleculas" | "interacciones" | "electromagnetismo" | "gravedad";
}) {
  const message =
    scope === "lattice"
      ...
      : scope === "atomos"
        ...
        : scope === "moleculas"
          ...
          : scope === "interacciones"
            ...
            : scope === "electromagnetismo"
              ? "Ley de Coulomb real entre cargas (k, softening ilustrativos, no valores SI), integrada con el metodo de Boris (el estandar en fisica de plasmas para la fuerza de Lorentz, que depende de la velocidad). El campo magnetico es uniforme e ilustrativo, no generado por las cargas: sin Biot-Savart ni radiacion electromagnetica, por lo que una carga acelerada (p.ej. en orbita) no pierde energia, a diferencia de la electrodinamica real."
              : scope === "gravedad"
